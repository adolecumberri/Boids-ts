parcelRequire=function(e,r,t,n){var i,o="function"==typeof parcelRequire&&parcelRequire,u="function"==typeof require&&require;function f(t,n){if(!r[t]){if(!e[t]){var i="function"==typeof parcelRequire&&parcelRequire;if(!n&&i)return i(t,!0);if(o)return o(t,!0);if(u&&"string"==typeof t)return u(t);var c=new Error("Cannot find module '"+t+"'");throw c.code="MODULE_NOT_FOUND",c}p.resolve=function(r){return e[t][1][r]||r},p.cache={};var l=r[t]=new f.Module(t);e[t][0].call(l.exports,p,l,l.exports,this)}return r[t].exports;function p(e){return f(p.resolve(e))}}f.isParcelRequire=!0,f.Module=function(e){this.id=e,this.bundle=f,this.exports={}},f.modules=e,f.cache=r,f.parent=o,f.register=function(r,t){e[r]=[function(e,r){r.exports=t},{}]};for(var c=0;c<t.length;c++)try{f(t[c])}catch(e){i||(i=e)}if(t.length){var l=f(t[t.length-1]);"object"==typeof exports&&"undefined"!=typeof module?module.exports=l:"function"==typeof define&&define.amd?define(function(){return l}):n&&(this[n]=l)}if(parcelRequire=f,i)throw i;return f}({"BjvI":[function(require,module,exports) {
...
},{}],"Tsyh":[function(require,module,exports) {
...
},{}],"hWtk":[function(require,module,exports) {
...
},{}],"Usl8":[function(require,module,exports) {
...
function e(e,n,o){return e[0]=n[0]*o[0],e[1]=n[1]*o[1],e}module.exports=e;
},{}],"iNN1":[function(require,module,exports) {
...
},{}],"LrCP":[function(require,module,exports) {
...
},{}],"KRz0":[function(require,module,exports) {
...
},{"./squaredLength":"ONEB"}],"NEO5":[function(require,module,exports) {
function e(e,n){return e[0]=-n[0],e[1]=-n[1],e}module.exports=e;
...
},{"./epsilon":"RG5D","./create":"CRrp","./clone":"eVWr","./fromValues":"Tsyh","./copy":"iGXv","./set":"dC9V","./equals":"hWtk","./exactEquals":"gDVz","./add":"Usl8","./subtract":"JBay","./sub":"l5jD","./multiply":"d4JS","./mul":"iNN1","./divide":"EB7T","./div":"zhrc","./inverse":"m1xm","./min":"oad5","./max":"AUfm","./rotate":"LrCP","./floor":"Q8bI","./ceil":"Q7XM","./round":"mON6","./scale":"KRz0","./scaleAndAdd":"bnjs","./distance":"oGij","./dist":"cAPJ","./squaredDistance":"Ltjm","./sqrDist":"UBwB","./length":"w4Ny","./len":"kwVs","./squaredLength":"ONEB","./sqrLen":"NCx7","./negate":"NEO5","./normalize":"ja96","./dot":"X7mn","./cross":"mRDr","./lerp":"Yu9h","./random":"AoO6","./transformMat2":"zRNY","./transformMat2d":"qn4h","./transformMat3":"t7q6","./transformMat4":"E8Jz","./forEach":"xpTd","./limit":"cwOV"}],"e5QE":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.heading=n,exports.map=r,exports.setLen=t;var e=require("gl-vec2");function r(e,r,t,n,o){return n+(e-r)/(t-r)*(o-n)}function t(r,t,n){return(0,e.normalize)(r,t),(0,e.scale)(r,r,n),r}function n(e){return Math.atan2(e[1],e[0])}
...
},{"gl-vec2":"cSMR","./gl-vec2-utils":"e5QE"}],"VexP":[function(require,module,exports) {
...
},{"json-stringify-safe":"VexP"}],"Cu39":[function(require,module,exports) {
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createScene=q,exports.scale=void 0;var e,n=require("../Flock"),t=require("../Boid"),o=require("random-seed"),r=require("gl-vec2"),i=require("../gl-vec2-utils"),a=require("./draw-utils"),c=document.getElementById("flame-count"),d=document.getElementById("boids-number"),l=document.getElementById("trail-check"),s=(new Date).getTime(),u=0,v=0,f=0,m=!1,g=(0,o.create)("dudee"),p=g.floatBetween,h=window.devicePixelRatio||1;function w(e,n){return{center:[e/2,n/2],canvasSize:[e,n],velocity:(0,r.set)((0,r.create)(),p(-1,1)/1.5,p(-1,1)/1.5),r:3,maxspeed:2/1.3,maxforce:.05,separationScale:1.5,alignScale:1,cohesionScale:1,desiredSeparation:25,neighborDistance:50}}exports.scale=h;var b=function(){var e=(new Date).getTime();return u=Math.floor(1e3/(e-s)),s=e,c.innerHTML=u+" fps",u},B=function(){d.innerHTML=e.boids.length+" boids"};function q(o,r,c){e=new n.Flock;var d=null;v=r,f=c;for(var s=0;s<50;s++){var u=new t.Boid(w(r,c));e.addBoid(u)}var g=function e(n){d=null,document.removeEventListener("mouseup",e)};document.addEventListener("mousedown",function(e){d=[e.pageX*h,e.pageY*h],document.addEventListener("mouseup",g)});console.log(l),l.addEventListener("change",function(){console.log("changed"),m=!m});var p=.5,b=100;requestAnimationFrame(function n(){e.run(d),o.fillStyle=m?"#f5f5dc2a":"#f5f5dc",d&&o.strokeRect(d[0]-b/2,d[1]-b/2,b,b),o.fillRect(0,0,r,c),o.strokeStyle="black";for(var t=0;t<e.boids.length;++t){var l=e.boids[t],s=l.position[0],u=l.position[1],v=(0,i.heading)(l.velocity)+Math.PI/2;(0,a.drawBoid)(o,s,u,v,l.r*p)}requestAnimationFrame(n)})}var y=setInterval(function(){if(e.boids.length<300){var n=new t.Boid(w(v,f));e.addBoid(n),B()}},250);
},{"../Flock":"NohL","../Boid":"Eahw","random-seed":"dE2i","gl-vec2":"cSMR","../gl-vec2-utils":"e5QE","./draw-utils":"Cu39"}],"EWEi":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.fit=void 0;var e=require("canvas-fit-margin-ts"),t=require("./scene"),r=document.createElement("canvas"),n=r.getContext("2d"),a=(0,e.createFit)(r,{scale:t.scale});function c(e,r){(0,t.createScene)(n,e,r)}exports.fit=a,document.querySelector(".canvas-container").appendChild(r);var o=function(){var e=a(),r=e[0],n=e[1];c(r*t.scale,n*t.scale)};o(),window.addEventListener("resize",o),module.hot&&module.hot.dispose(function(){return r.remove()});
},{"canvas-fit-margin-ts":"d9wR","./scene":"kh5L"}]},{},["EWEi"], null)
//# sourceMappingURL=demo.7e0d9d0c.js.map